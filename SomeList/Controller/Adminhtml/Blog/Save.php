...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\SomeDemo\SomeList\Model\Blog::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('somedemo_somelist_blog');
            ...
            $this->dataPersistor->set('somedemo_somelist_blog', $data);
